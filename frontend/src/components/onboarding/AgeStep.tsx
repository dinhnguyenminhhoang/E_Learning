...
export function AgeStep({ ageRanges, value, onChange }: AgeStepProps) {
  return (
    <motion.div
        ...
        <div className="grid grid-cols-4 gap-4">
          {ageRanges.map((range) => (
            <div key={range.value}>
              ...
              <Label
                htmlFor={range.value}
                className="flex items-center justify-center rounded-xl border-2 border-gray-200 bg-white px-4 py-4 hover:bg-gray-50 peer-data-[state=checked]:border-blue-600 peer-data-[state=checked]:bg-blue-50 cursor-pointer transition-all"
              >
