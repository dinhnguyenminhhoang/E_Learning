    ...
    <div className="space-y-6">
      <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-r">
        ...
        <p className="text-sm text-gray-600 mt-2">
          Drag items from the left to match with items on the right, or click a
          left item then click a right item to match them.
        </p>
      </div>
                  ...
                  <div className="mt-2 pt-2 border-t border-green-200">
                    <div className="flex items-center gap-2 text-sm text-green-700">
                      ...
                      <span>
                        Matched with:{" "}
                        {
                          state.rightItems.find((r) => r.id === matchedRightId)
                            ?.right
                        }
                      </span>
                    </div>
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <span
                    className={cn(
                      "text-base font-medium",
                      isMatched ? "text-green-900" : "text-gray-900"
                    )}
                  >
                    {item.right}
                  </span>
                ...
                {isMatched && matchedLeftId && (
                  <div className="mt-2 pt-2 border-t border-green-200">
                    <div className="text-sm text-green-700">
                      Matched with:{" "}
                      {
                        state.leftItems.find((l) => l.id === matchedLeftId)
                          ?.left
                      }
                    </div>
                  </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            ...
            style={{
              width: `${(state.matches.size / state.leftItems.length) * 100}%`,
            }}
          />
        </div>
      </div>
