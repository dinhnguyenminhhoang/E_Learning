...
import { MediaUploader, SourceType } from "@/components/admin/blocks/shared/MediaUploader";
...
export default function CreateBlockPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response: any = await blockService.createBlock(payload);

            if (response.code === 200 || response.code === 201) {
                toast.success("Tạo block thành công!");
                router.push("/admin/blocks");
            } else {
                toast.error(response.message || "Không thể tạo block");
            }
        } catch (error: any) {
    ...
    return (
        <div className="p-6 mx-auto max-w-4xl">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600">Thêm block mới vào hệ thống</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm space-y-6">
                    ...
                    <div className={`grid grid-cols-1 ${formData.type === "grammar" ? "md:grid-cols-4" : "md:grid-cols-3"} gap-4`}>
                        ...
                        {formData.type === "grammar" && formData.grammar?.sourceType != "upload" && (
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-2">
                                    Thời lượng (phút)
                                </label>
                                <Input
                                    ...
                                    onChange={(e) => handleCommonFieldChange("duration", Number(e.target.value))}
