    ...
    <div className="p-8 mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">
          Create an exam with multiple sections for different skills
        </p>
      </div>
                ...
                <div className="flex-1">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      const minutes =
                        Math.floor(
                          (form.watch("totalTimeLimit") % 3600) / 60
                        ) || 0;
                      form.setValue(
                        "totalTimeLimit",
                        formatTimeToSeconds(hours, minutes)
                      );
                    }}
                  />
                      ...
                      <div className="flex-1 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label>Skill</Label>
                            <Select
                              value={form.watch(`sections.${index}.skill`)}
                          ...
                          <div>
                            ...
                            <Input
                              type="number"
                              {...form.register(`sections.${index}.maxScore`, {
                                valueAsNumber: true,
                              })}
                        ...
                        <div>
                          ...
                          <QuizPicker
                            ...
                            skill={form.watch(`sections.${index}.skill`)}
                          />
                        </div>
                      </div>
