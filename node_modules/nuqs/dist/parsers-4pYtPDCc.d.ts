...
type inferSingleParserType<Parser> = Parser extends GenericParserBuilder<infer Value> & {
  defaultValue: infer Value;
} ? Value : Parser extends GenericParserBuilder<infer Value> ? Value | null : never;
...
//#endregion
export { GenericParser, GenericParserBuilder, HistoryOptions, LimitUrlUpdates, MultiParser, MultiParserBuilder, Nullable, Options, Parser, ParserBuilder, ParserMap, ParserWithOptionalDefault, SearchParams, SingleParser, SingleParserBuilder, UrlKeys, createMultiParser, createParser, inferParserType, parseAsArrayOf, parseAsBoolean, parseAsFloat, parseAsHex, parseAsIndex, parseAsInteger, parseAsIsoDate, parseAsIsoDateTime, parseAsJson, parseAsNativeArrayOf, parseAsNumberLiteral, parseAsString, parseAsStringEnum, parseAsStringLiteral, parseAsTimestamp };
//# sourceMappingURL=parsers-4pYtPDCc.d.ts.map